...
class DbInitializer {
    ...
    fun getBooks(): Collection<Book> {
        return setOf(
            Book(null, "Маленький принц", "Сент-Экзюпери", "100", "https://upload.wikimedia.org/wikipedia/commons/thumb/3/32/Books-aj.svg_aj_ashton_01f.svg/2310px-Books-aj.svg_aj_ashton_01f.svg.png", "Description", "0000001",
                favourite = false,
                later = false
            ),
            Book(null,"Метро 2033", "Д. Глуховский", "99", "https://cdn1.ozone.ru/multimedia/1007119597.jpg", "SFafafaf", "0000002",
                favourite = false,
                later = false
            ),
            Book(null,"Успеть до восхода", "Е. Бедарев", "101", "https://static-cse.canva.com/blob/231917/%D0%A3%D1%81%D0%BF%D0%B5%D1%82%D1%8C-%D0%B4%D0%BE-%D0%B2%D0%BE%D1%81%D1%85%D0%BE%D0%B4%D0%B0.png", "arhgghrehregrwgrhrhrwwgwegew", "0000003",
                favourite = false,
                later = false
            ),
            Book(null, "Пикник на обочине", "Стругацкие", "101", "https://kbimages1-a.akamaihd.net/fa69eb0d-9706-4d70-bd94-7f0d3a3dbba3/1200/1200/False/harry-potter-the-complete-collection-1-7-1.jpg", "egGGAGAGWGWERGEGSG", "0000004",
                favourite = false,
                later = false
            ),
            ...
            Book(null, "Портрет Дориана Грея", "О. Уайльд", "100", "https://upload.wikimedia.org/wikipedia/commons/thumb/3/32/Books-aj.svg_aj_ashton_01f.svg/2310px-Books-aj.svg_aj_ashton_01f.svg.png", "Description", "0000006",
                favourite = false,
                later = false
            ),
